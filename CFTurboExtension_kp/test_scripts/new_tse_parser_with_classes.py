...
#
#
#     def extract_attribs(self, start, end):
#         attribs = {}
#         with open(self.tse_path) as f:
#             for line in f:
#                 if line.strip() == start:
#                     break
#
...
class Geometry:
    def __init__(self, tse_path, start, end):
        self.tse_path = tse_path
        self.start = start
        self.end = end

    def extract_attribs(self):
        attribs = {}
        with open(self.tse_path) as f:
            for line in f:
...
class MachineData(Geometry):
    Geometry.extract_attribs('MACHINE DATA:', 'END')




# def start(tse_path):
#     geometry = Geometry(tse_path)
#
#     machine_data = geometry.extract_attribs('MACHINE DATA:', 'END')
#     hub = geometry.extract_attribs('HUB:', 'END')
#     splitter_blade = geometry.extract_attribs('BLADE:Splitter blade', 'END')
